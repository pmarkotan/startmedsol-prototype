...
/**
 * REST controller for managing {@link hu.paninform.startmedsol.domain.Provider}.
 */
@RestController
@RequestMapping("/api")
public class ProviderResource {
    ...
    public ResponseEntity<List<ProviderDTO>> getAllProviders(Pageable pageable, @RequestParam(required = false, defaultValue = "false") boolean eagerload) {
