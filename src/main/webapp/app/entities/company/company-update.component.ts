...
export class CompanyUpdateComponent implements OnInit {
  ...
  editForm = this.fb.group({
    ...
    workplaceName: [null, [Validators.required, Validators.maxLength(50)]],
    workplaceId: [null, [Validators.required, Validators.maxLength(20)]],
  });
  ...
  updateForm(company: ICompany): void {
    this.editForm.patchValue({
      ...
      workplaceId: company.workplaceId,
    });
  }
  ...
  private createFromForm(): ICompany {
    return {
      ...
      workplaceName: this.editForm.get(['workplaceName'])!.value,
      workplaceId: this.editForm.get(['workplaceId'])!.value,
    };
  }
