...
export class StatisticsComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.statisticsService
      ...
      .subscribe(
        (res: HttpResponse<IStatistics[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInStatistics(): void {
    this.eventSubscriber = this.eventManager.subscribe('statisticsListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IStatistics[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
