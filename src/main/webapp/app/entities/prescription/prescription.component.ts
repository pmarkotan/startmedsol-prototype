...
export class PrescriptionComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.prescriptionService
      ...
      .subscribe(
        (res: HttpResponse<IPrescription[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInPrescriptions(): void {
    this.eventSubscriber = this.eventManager.subscribe('prescriptionListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IPrescription[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
