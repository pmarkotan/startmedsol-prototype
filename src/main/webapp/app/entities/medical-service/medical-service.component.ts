...
export class MedicalServiceComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.medicalServiceService
      ...
      .subscribe(
        (res: HttpResponse<IMedicalService[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInMedicalServices(): void {
    this.eventSubscriber = this.eventManager.subscribe('medicalServiceListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IMedicalService[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
