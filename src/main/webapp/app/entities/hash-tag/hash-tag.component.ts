...
export class HashTagComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.hashTagService
      ...
      .subscribe(
        (res: HttpResponse<IHashTag[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInHashTags(): void {
    this.eventSubscriber = this.eventManager.subscribe('hashTagListModification', () => this.loadPage());
  }
