...
import hu.paninform.startmedsol.domain.Address;
import hu.paninform.startmedsol.repository.AddressRepository;
import hu.paninform.startmedsol.service.AddressService;
import hu.paninform.startmedsol.service.dto.AddressDTO;
import hu.paninform.startmedsol.service.mapper.AddressMapper;
...
public class AddressResourceIT {
    ...
    private static final AddressType DEFAULT_TYPE = AddressType.PLACE_OF_RESIDENCE;
    private static final AddressType UPDATED_TYPE = AddressType.PLACE_OF_STAY;
    ...
    public void createAddress() throws Exception {
        ...
        assertThat(testAddress.getMunicipality()).isEqualTo(DEFAULT_MUNICIPALITY);
    ...
    public void updateAddress() throws Exception {
        ...
        assertThat(testAddress.getMunicipality()).isEqualTo(UPDATED_MUNICIPALITY);
