...
import { NavSettingsComponent } from 'app/entities/nav-settings/nav-settings.component';
...
describe('Component Tests', () => {
  describe('NavSettings Management Component', () => {
    let comp: NavSettingsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(NavSettingsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.navSettings && comp.navSettings[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
