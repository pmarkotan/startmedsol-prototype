...
import { FeedBackMessageComponent } from 'app/entities/feed-back-message/feed-back-message.component';
...
describe('Component Tests', () => {
  describe('FeedBackMessage Management Component', () => {
    let comp: FeedBackMessageComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(FeedBackMessageComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.feedBackMessages && comp.feedBackMessages[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
