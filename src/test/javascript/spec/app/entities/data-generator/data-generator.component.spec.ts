...
import { DataGeneratorComponent } from 'app/entities/data-generator/data-generator.component';
...
describe('Component Tests', () => {
  describe('DataGenerator Management Component', () => {
    let comp: DataGeneratorComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DataGeneratorComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.dataGenerators && comp.dataGenerators[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
