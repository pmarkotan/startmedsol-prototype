...
import { DictionaryItemComponent } from 'app/entities/dictionary-item/dictionary-item.component';
...
describe('Component Tests', () => {
  describe('DictionaryItem Management Component', () => {
    let comp: DictionaryItemComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DictionaryItemComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.dictionaryItems && comp.dictionaryItems[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
