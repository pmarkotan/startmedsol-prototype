...
import { PraxisComponent } from 'app/entities/praxis/praxis.component';
import { PraxisService } from 'app/entities/praxis/praxis.service';
import { Praxis } from 'app/shared/model/praxis.model';

describe('Component Tests', () => {
  describe('Praxis Management Component', () => {
    let comp: PraxisComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PraxisComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.praxes && comp.praxes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
